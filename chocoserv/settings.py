# Django settings for chocoserv project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'chocodb',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '=!4513^*%i)wu9^6d0x48hoteogk)gbp7$9i(1f3iz(0%qkr=z'
...
WSGI_APPLICATION = 'chocoserv.wsgi.application'
